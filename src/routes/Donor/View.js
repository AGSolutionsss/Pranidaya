                    ...
                    <div className="row">
                      ...
                      {donor.indicomp_type == "Individual" && (
                        <div>
                          <div className="col-sm-6 col-md-6 col-xl-3">
                            <div className="form-group">
                              <p style={label1}>Father Name</p>{" "}
                              <p style={label2}>{donor.indicomp_father_name}</p>
                            </div>
                          </div>
                          <div className="col-sm-6 col-md-6 col-xl-3">
                            <div className="form-group">
                              <p style={label1}>Mother Name</p>{" "}
                              <p style={label2}>{donor.indicomp_mother_name}</p>
                            </div>
                          </div>
                          <div className="col-sm-6 col-md-6 col-xl-3">
                            <div className="form-group">
                              <p style={label1}>Spouse Name</p>{" "}
                              <p style={label2}>{donor.indicomp_spouse_name}</p>
                            </div>
                          </div>
                          <div className="col-sm-6 col-md-6 col-xl-3">
                            <div className="form-group">
                              <p style={label1}>DOA</p>{" "}
                      ...
                      <div className="col-sm-6 col-md-6 col-xl-3">
                        <div className="form-group">
                          ...
                          <p style={label2}>{donor.indicomp_gender}</p>
                        </div>
                      </div>

                      <div className="col-sm-6 col-md-6 col-xl-3">
                        <div className="form-group">
                          <p style={label1}>PAN Number</p>{" "}
                          <p style={label2}>{donor.indicomp_pan_no}</p>
                        </div>
                      </div>
                      <div className="col-sm-6 col-md-6 col-xl-3">
                        <div className="form-group">
                          <p style={label1}>Promoter</p>{" "}
                          <p style={label2}>{donor.indicomp_promoter}</p>
                        </div>
                      </div>
                      <div className="col-sm-6 col-md-6 col-xl-3">
                        <div className="form-group">
