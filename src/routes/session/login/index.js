                           ...
                           <div className="session-body text-center">
                              ...
                              <Form>
                                 <FormGroup className="has-wrapper">
                                    <Input type="text" value={email} name="user-mail" id="user-mail" className="has-input input-lg" placeholder="Enter Email Address" onChange={(event) => this.setState({ email: event.target.value })} />
