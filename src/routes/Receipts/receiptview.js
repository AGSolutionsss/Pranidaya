            ...
            <RctCard>
              ...
              className="invoice-head text-right">
                <ul className="list-inline">
                  <li>
                    <a href={"https://legacy.ftschamp.com/public/generate-pdf?id=" + theId}>
                      <i className="mr-10 ti-download"></i> Download
                    </a>
                  </li>
                  <li>
                  <ReactToPdf targetRef={componentRef} filename={receipts.receipt_no+".pdf"}>
                      {({toPdf}) => (
                          <a onClick={toPdf}><i className="mr-10 ti-download"></i>Generate pdf</a>
                      )}
                  </ReactToPdf>
                  </li>
                  <li>
                  ...
                  <a onClick={() => sendEmail("https://legacy.ftschamp.com/public/sendMail?id=" + theId + "&indicomp_id="+ receipts.indicomp_fts_id)} >
                  ...
                  <li>
                    <ReactToPrint
                      trigger={() => (
                        <a target="_blank" href={"https://legacy.ftschamp.com/public/printfReceipt?id=" + theId}>
